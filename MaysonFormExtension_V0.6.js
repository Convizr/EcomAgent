      ...
      formContainer.innerHTML = `
        <style>
          ...
          input[type="submit"] {
            ...
            width: 70%;
            display: block;
            margin: 20px auto 0 auto; /* Extra ruimte boven de knop */
            border-radius: 0; /* Border-radius verwijderd voor rechthoekige look */
          }
          input[type="submit"]:hover {
            background-color: #f9b2b2; /* Roze hover-kleur */
            color: #000;
