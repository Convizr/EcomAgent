    ...
    render: async ({ trace, element }) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          // Zorg ervoor dat de datums in het juiste formaat zijn
          availableDates = result.records.map(record => {
        ...
        // Je zou hier kunnen kiezen om een bericht naar de gebruiker te tonen of een fallback-mechanisme te gebruiken
      }
