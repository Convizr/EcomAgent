    ...
    render: ({ trace, element }) => {
      ...
      formContainer.innerHTML = `
        <style>
          label {
            display: block;
            margin: 0 0 5px 0; /* Margin top verwijderd */
            font-size: 15px; /* Font size aangepast */
            color: #333;
          }
          .quantity-container {
            display: flex;
            ...
            margin: 0; /* Margin top verwijderd */
          ...
          fieldset {
            ...
            font-size: 17px; /* Font size aangepast */
          }
          legend {
            font-size: 17px; /* Font size aangepast */
            font-weight: bold;
          ...
          input[type="submit"] {
            ...
            position: relative;
            margin-top: -10px; /* Overlap met het witte vak */
            left: 50%; /* Gecentreerd in het witte vak */
            transform: translateX(-50%);
          }
          input[type="submit"]:hover {
            background-color: #a39481;
            transform: translateX(-50%) scale(1.05); /* Vergroten bij hover */
