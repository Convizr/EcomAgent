...
export const GofileUploadExtension = {
    ...
    render: async ({ trace, element }) => {
      // Assuming `gofileApiKey` is available in the global scope or passed via the `trace` object
      const gofileApiKey = trace.payload.gofileApiKey || window.voiceflow.variables.get('gofileApiKey');
