export const ProductFormExtension = {
    ...
    render: ({ trace, element }) => {
        ...
        // Generate taste options HTML
        const tasteOptionsHTML = uniqueTastes.length ? uniqueTastes.map(taste => `<option value="${taste}">${taste}</option>`).join('') : '<option value="">No tastes available</option>';
