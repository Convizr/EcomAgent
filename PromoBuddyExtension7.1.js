export const CustomFormExtension = {
  ...
  render: ({ trace, element }) => {
      ...
      formContainer.innerHTML = `
          ...
          <label for="quantity" class="special-label">Quantity:</label>
          <input type="number" id="quantity" name="quantity" min="1" required><br>

          <label for="budget" class="special-label">Budget:</label>
          <input type="text" id="budget" name="budget" required><br>

          <label for="color" class="special-label">Color:</label>
          ...
          <label for="deadline" class="special-label">Deadline:</label>
          ...
          <label for="delivery" class="special-label">Delivery:</label>
  ...
  render: ({ trace, element }) => {
      ...
      formContainer.innerHTML = `
        <style>
          ...
          <label for="company" class="special-label">Company:</label>
          <input type="text" id="company" name="company" required><br>

          <label for="clientName" class="special-label">Client Name:</label>
          <input type="text" id="clientName" name="clientName" required><br>

          <label for="clientEmail" class="special-label">Client Email:</label>
...
export const GofileUploadExtension = {
          ...
          if (uploadData.status === 'ok') {
            ...
            try {
              ...
              if (directLinkData.status === 'ok') {
                ...
                gofileUploadContainer.innerHTML = `<img src="" alt="Done" width="50" height="50">`;
  ...
  export const BrandingTypeSelectExtension = {
    name: 'BrandingTypeSelect',
    type: 'response',
    match: ({ trace }) =>
        trace.type === 'branding_type_select' || trace.payload.name === 'branding_type_select',
    render: ({ trace, element }) => {
        ...
        selectContainer.innerHTML = `
            ...
            <div class="select-box">
                <label for="brandingType">Branding type:</label>
                <select id="brandingType" name="brandingType">
                    <option value="Embroidery">Embroidery</option>
                    <option value="Pad print">Pad print</option>
                    <option value="Silkscreen">Silkscreen</option>
                    <option value="Digital Direct">Digital Direct</option>
        ...
        selectElement.addEventListener('change', () => {
            window.voiceflow.chat.interact({
                type: 'complete',
                payload: {
                    brandingType: selectElement.value
                },
            });
        });
