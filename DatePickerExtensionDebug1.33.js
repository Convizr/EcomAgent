export const DatePickerExtension = {
  ...
  render: ({ trace, element }) => {
    // Directly parsing the 'checkAvailableDates' from the payload assuming it's a JSON string.
    let availableDates = [];
    try {
      // Since trace.payload is a stringified JSON object, first parse it to get the object
      payloadObj = JSON.parse(trace.payload);
      // Now, parse the 'checkAvailableDates' property to get the array of dates
