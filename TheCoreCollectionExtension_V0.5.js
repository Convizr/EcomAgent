      ...
      formContainer.innerHTML = `
        <style>
          ...
          .quantity-container {
            ...
            border-radius: 5px;
            background-color: #fff; /* Witte achtergrond voor de knoppen en input */
          }
          .quantity-btn {
            border: 1px solid #ccc;
          ...
          .quantity-input {
            ...
            border: none;
            margin: 0;
            background-color: #fff; /* Witte achtergrond voor de input */
          ...
          input[readonly] {
            ...
            border-radius: 4px;
            width: 95%; /* Zelfde breedte als andere inputvelden */
            padding: 8px;
          }
          fieldset {
            border: none;
          ...
          input[type="submit"] {
            ...
            color: #fff;
            border: none;
            padding: 6px 12px; /* Kleinere submit-knop */
            border-radius: 4px;
            cursor: pointer;
            width: auto;
            font-size: 14px;
            ...
            margin-top: 10px; /* Afstand van de knop tot de form-elementen */
          }
