    ...
    render: ({ trace, element }) => {
      ...
      formContainer.innerHTML = `
        <style>
          ...
          select {
            background-color: #fff; /* Verwijder de grijze achtergrondkleur van de dropdown */
          }
          input[readonly] {
            background-color: #fff; /* Zorg ervoor dat het 'Country' veld hetzelfde is als andere velden */
            color: #333;
            cursor: not-allowed;
          }
          input[type="submit"] {
            ...
            width: auto;
            display: block;
            margin: 10px auto 0 auto; /* Zorg ervoor dat de knop gecentreerd blijft */
            transition: transform 0.2s, background-color 0.3s; /* Zorg dat de knop alleen groter wordt */
          }
          input[type="submit"]:hover {
            transform: scale(1.05); /* Alleen vergroten, geen verschuiving */
            background-color: #a39481;
          }
        </style>
