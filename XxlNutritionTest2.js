    ...
    render: ({ trace, element }) => {
      ...
      formContainer.innerHTML = `
        ...
        <fieldset id="orderDetails">
          ...
          <label for="size" class="${payloadObj.orderProductSize === '0' ? 'hidden' : 'visible'}">Maat:</label>
          ...
          <label for="taste" class="${payloadObj.orderProductTaste === '0' ? 'hidden' : 'visible'}">Smaak:</label>
          <select id="taste" name="taste" class="${payloadObj.orderProductTaste === '0' ? 'hidden' : 'visible'}">
            <option value="">Selecteer een smaak</option>
        ...
        <fieldset id="customerInfo" class="hidden">
          ...
          <label for="apartmentNumber">Appartementnummer (Optioneel):</label>
