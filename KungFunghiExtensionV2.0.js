export const GofileUploadExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      formContainer.innerHTML = `
        ...
        <fieldset id="customerInfo" class="hidden">
          ...
          <label for="fullName">${lb_fullName}</label>
          <input type="text" id="fullName" name="fullName" required>
  
          <label for="email">${lb_email}</label>
          <input type="email" id="email" name="email" required>
  
          <label for="address">${lb_address}</label>
          <input type="text" id="address" name="address" required>
  
          <label for="apartmentNumber">${lb_appartmentNumber}</label>
  ...
  export const PersonalInfoFormExtension = {
    ...
    render: ({ trace, element }) => {
      ...
      const {
        bt_submit, lb_fullName, lb_email, lb_address, lb_appartmentNumber, lb_postalCode, lb_city, lb_country, lb_personalInformation
      } = payloadObj;
